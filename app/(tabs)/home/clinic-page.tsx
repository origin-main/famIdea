                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                {/* Clinic Details */}
                                <View style={{ alignItems: "flex-start", gap: 3, width: "80%" }}>
                                    <View
                                        style={{
                                            flexDirection: "row",
                                            alignItems: "center",
                                    ...
                                    >
                                        <Text style={{ fontSize: 13, fontWeight: "bold" }}>Margarita birthing center</Text>
                                        <IconButton
                                            size={15}
                                            icon="heart-outline"
                                            iconColor={"black"}
                        ...
                        <View style={{ alignItems: "center" }}>
                            <TouchableOpacity style={styles.loginButton} onPress={() => router.push("/messaging/chat")}>
